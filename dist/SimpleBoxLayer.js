...
L.LatLngBounds.prototype.toSimpleBoxBBoxString = function (){
  var a = this._southWest,
  b = this._northEast;
  return [a.lat, a.lng, b.lat, b.lng].join(",");
}

L.SimpleBoxLayer = L.FeatureGroup.extend({
  options: {
    debug: false,
    minzoom: 15,
    ...
    beforeRequest: function() {
      if (this.options.debug) {
        console.debug('about to query the SimpleBoxAPI');
      }
    },
...
//L.SimpleBoxLayer = function (options) {
//  return new L.SimpleBoxLayer(options);
//};
